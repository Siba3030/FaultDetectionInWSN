...
dataDescriptor::dataDescriptor() : cClassDescriptor("data", "")
{
}
...
{
    this->mydata_var = other.mydata_var;
}

void MyPacket::parsimPack(cCommBuffer *b)
{
    ::ApplicationPacket::parsimPack(b);
    doPacking(b,this->mydata_var);
}

void MyPacket::parsimUnpack(cCommBuffer *b)
{
    ::ApplicationPacket::parsimUnpack(b);
    doUnpacking(b,this->mydata_var);
}

data& MyPacket::getMydata()
{
    return mydata_var;
}

void MyPacket::setMydata(const data& mydata)
{
    this->mydata_var = mydata;
}
...
int MyPacketDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount(object) : 0;
    if (fieldName[0]=='m' && strcmp(fieldName, "mydata")==0) return base+0;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}
...
std::string MyPacketDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    MyPacket *pp = (MyPacket *)object; (void)pp;
    switch (field) {
        case 0: {std::stringstream out; out << pp->getMydata(); return out.str();}
        default: return "";
    }
}
...
const char *MyPacketDescriptor::getFieldStructName(void *object, int field) const
{
    ...
    switch (field) {
        case 0: return opp_typename(typeid(data));
        default: return NULL;
    };
}
...
void *MyPacketDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    ...
    MyPacket *pp = (MyPacket *)object; (void)pp;
    switch (field) {
        case 0: return (void *)(&pp->getMydata()); break;
        default: return NULL;
    }
}
